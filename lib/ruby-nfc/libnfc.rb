...
module LibNFC
  ...
  attach_function :nfc_perror, %i[pointer string], :void
  attach_function :nfc_list_devices, %i[pointer pointer size_t], :size_t
  ...
  attach_function :nfc_open, %i[pointer string], :pointer
  ...
  attach_function :str_nfc_target, %i[pointer pointer bool], :int
